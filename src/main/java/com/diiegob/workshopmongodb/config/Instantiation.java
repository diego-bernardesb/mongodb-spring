package com.diiegob.workshopmongodb.config;
...
import com.diiegob.workshopmongodb.dto.AuthorDTO;
import com.diiegob.workshopmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		userRepository.saveAll(Arrays.asList(maria, alex, bob));//persistir os usuarios antes do post para poder instanciar o authorDTO no post
